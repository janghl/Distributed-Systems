...
int main(int argc, char** argv){
	if(argc!=3)
		std::cout<<"usage: maching number, line number"<<std::endl;
	int line_number = std::stoi(argv[2]);
	int machine = std::stoi(argv[1]);
	...
	std::cout << "sequence3: " << sequence3 << std::endl;
	std::cout << "sequence4: " << sequence4 << std::endl;
	std::cout << "sequence5: " << sequence5 << std::endl;
	std::cout << "sequence6: " << sequence6 << std::endl;
